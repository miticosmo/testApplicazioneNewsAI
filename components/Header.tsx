      ...
      <div className="max-w-7xl mx-auto w-full flex justify-between items-center pointer-events-auto">
        <div className="flex items-center gap-2">
          <div className="bg-white/80 backdrop-blur-md border border-white/40 px-5 py-2 rounded-full shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
            <span className="font-bold text-xl tracking-tight text-crextio-dark cursor-pointer transition-all duration-300 hover:text-crextio-yellow hover:-translate-y-0.5 inline-block">AI Radar <span className="text-crextio-yellow">&#9679;</span> Live</span>
          </div>
        </div>
